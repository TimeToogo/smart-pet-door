...
export default class Frequencies {
  static init(cfg, events) {
    ...
    const LABELS = {};
    LABELS[cfg.events.SIGHTING] = { label: "In the courtyard", colour: "#75F4FA" };
    LABELS[cfg.events.WENT_INSIDE] = { label: "Went inside", colour: "#7EFA95" };
    LABELS[cfg.events.WENT_OUTSIDE] = { label: "Went outside", colour: "#FAE66E" };
